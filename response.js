...
function animation() {
    var typed = new Typed(".animate", {
        strings: [
            "The heaven rejoices",
            "For an angel is about to be born",
            "The cloud roared as never before",
            "cause a queen is about to be birthed",
            "Behold earth hath never seen its kind before",
            "for the earth shooked and the wind blew",
            "A girl of great courage",
            "A mighty person",
            "A girl who is to redeem the earth.",
        ],
        typespeed: 300,
        backspeed: 100,
        loop: false,
...
function typewriter() {
    if (number < texts.length) {
        p.innerHTML += texts.charAt(number);
        number++;
